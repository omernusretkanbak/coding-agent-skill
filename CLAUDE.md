...
- Her görevde worktree kullan: `EnterWorktree` (ad = görev slug'ı). Araç kullanılamıyorsa `new-feature` (c)'deki kök tespitiyle `git worktree add "<kök>/.claude/worktrees/<dal-slug>" -b <dal-slug> origin/main` (asla göreli yol).
